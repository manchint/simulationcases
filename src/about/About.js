    ...
    return (
        <div className="about-container">
            <div className='about-content'>
                ...
                <br></br>
                <p>Let’s raise the bar—together. We welcome your insights, questions, and feedback. Join the conversation and help us shape the future of healthcare training.</p>
